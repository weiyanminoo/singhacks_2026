...
| **1:30–1:50** | Three purchases land. Hashes appear as clickable links. Envelope drains $10.00 → $2.82. | "Three purchases, on ledger, in about ninety seconds. Every hash is live on the explorer, and each carries the decision that caused it and the rule that permitted it." |
...
- [ ] **Every figure in the beat sheet replaced with numbers from the actual
      recorded run** — `$2.82`, the discovery total ($0.14 at 7 × $0.02) and the
